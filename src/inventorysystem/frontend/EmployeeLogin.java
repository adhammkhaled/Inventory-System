...
import static inventorysystem.constants.LoginCredentials.EMPLOYEE_PASSWORD;
import static inventorysystem.constants.LoginCredentials.EMPLOYEE_USERNAME;
...
public class EmployeeLogin extends javax.swing.JFrame implements Node{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().equals(EMPLOYEE_USERNAME)&&jPasswordField1.getText().equals(EMPLOYEE_PASSWORD)){
            this.dispose();
            EmployeeFrame employeeFrame = new EmployeeFrame();
            employeeFrame.setParentNode(this.getParentNode());
